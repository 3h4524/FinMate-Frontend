...
async function loadSidebarHTML() {
    try {
        ...
        let sidebarPath = '/pages/sidebar.html'; // Use absolute path as default
        
        // If we're in a subdirectory, adjust the path
        if (currentPath.includes('/pages/goal/goal_detail/')) {
...
function setActiveTab() {
    ...
    if (currentPage.includes('home')) {
        ...
        activeItem = document.querySelector('[data-page="goal"]');
